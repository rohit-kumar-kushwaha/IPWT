...
<head>
    ...
    <title>>> Student details | Thinking Byte</title>
        ...
        <div class="form">
            <form action="registration-form.php" name="regform" id="admissionform" method="POST" enctype="multipart/form-data" onsubmit='return validate_form()'>
                ...
                <div class="fotor">
                    ...
                    <a href="edit-form.php?id=<?php echo $student_id ?>" class="fbtne">Edit</a>
                    <a href="payment.php?id=<?php echo $student_id ?>" class="fbtne">Payment</a>
