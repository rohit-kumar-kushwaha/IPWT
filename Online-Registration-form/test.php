...
<body>
    ...
    <div class="wm-main-wrapper">
        ...
        <div class="wm-main-banner">
            ...
            <div class="wm-banner-one1">
            <!-- <h1>hello</h1> -->
                <div class="wm-banner-one-for1">
                <!-- <h1>hello 1</h1> -->
                ...
                <div class="wm-banner-one-nav1">
                    <div class="wm-banner-one-nav-layer" style="background-color:#222845">
                        <h1 style="color:white">International Programmes</h1>
                        <p style="color:white">The study programmes of the Enroll Campus University are open to people from all
                            nationalities.</p>
                        <a href="#" class="wm-banner-btn" style="background-color:#b99663;color:white">learn more</a>
                    </div>
        ...
        <!--// Main Content \\-->
        <div class="wm-main-content1">

           
        
            <!--// Main Section \\-->
            <div class="wm-main-section1 wm-learn-listing-full">
